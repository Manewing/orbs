...
void flush_stats(stats_t *stats) {
  ...
  fwrite(stats->avg_life_time, sizeof(int), STATS_BUFFER_SIZE, stats->avg_life_time_f);
  fwrite(stats->avg_instr_usage, sizeof(int), STATS_BUFFER_SIZE, stats->avg_instr_usage_f);
